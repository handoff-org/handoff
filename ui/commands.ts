...
export const COMMANDS: Command[] = [
  ...
  { name: '/note-paper', desc: 'annotate a paper with key passages and relevance  (/note-paper <id>)' },
  { name: '/lit-notes', desc: 'list structured notes for papers  (/lit-notes [paper_id])' },
  { name: '/snowball', desc: 'expand forward/backward citations  (/snowball <id> [forward|backward|both])' },
  { name: '/lit-review', desc: 'draft Related Work from paper notes  (/lit-review [tag …])' },
  { name: '/bind', desc: 'bind a number in the paper to a run metric  (/bind <file> <line> <raw> <run_id> <metric>)' },
  ...
  { name: '/stats', desc: 'compute CIs and effect sizes for run metrics  (/stats <run_ids> <metric> [baseline_run_ids])' },
  { name: '/draft-section', desc: 'co-write a paper section from claims and notes  (/draft-section <section>)' },
  { name: '/fix-paper', desc: 'compile and auto-fix LaTeX errors (up to 3 rounds)' },
  { name: '/preview-figure', desc: 'render a figure or PDF page inline in the terminal  (/preview-figure <path>)' },
