...
const SOTA_DB: BenchmarkSota[] = [
  ...
  // ── ScienceAgentBench ────────────────────────────────────────────────────────
  // Paper: arXiv:2410.05080 (Chen et al., Oct 2024)
  // Pass = program executes and produces the expected output (execution-based).
  // Results from Table 2 of the paper (direct-prompt and agent configs).
  {
    name: 'ScienceAgentBench',
    npmScript: 'bench:science-agent',
    source: 'Chen et al., arXiv:2410.05080 (Oct 2024)',
    metric: 'execution-based (program produces expected output)',
    leaderboard: 'https://github.com/OSU-NLP-Group/ScienceAgentBench#leaderboard',
    overall: {
      best: { agent: 'Direct prompting', model: 'o1-preview', passRate: 0.269, date: '2024-10',
        notes: 'best result reported at paper publication' },
      others: [
        { agent: 'Direct prompting', model: 'Claude-3.5-Sonnet', passRate: 0.212, date: '2024-10' },
        { agent: 'Direct prompting', model: 'GPT-4o', passRate: 0.173, date: '2024-10' },
        { agent: 'CodeAct Agent', model: 'GPT-4o', passRate: 0.115, date: '2024-10',
          notes: 'multi-turn agent; lower than direct prompting' },
      ],
    },
    byDomain: {
      Bioinformatics: {
        best: { agent: 'Direct prompting', model: 'o1-preview', passRate: 0.286, date: '2024-10' },
      },
      'Computational Chemistry': {
        best: { agent: 'Direct prompting', model: 'o1-preview', passRate: 0.321, date: '2024-10' },
      },
      GIS: {
        best: { agent: 'Direct prompting', model: 'o1-preview', passRate: 0.200, date: '2024-10' },
      },
      Psychology: {
        best: { agent: 'Direct prompting', model: 'o1-preview', passRate: 0.280, date: '2024-10' },
      },
    },
  },

  // ── SciCode ──────────────────────────────────────────────────────────────────
  // Paper: arXiv:2407.13168 (Sprueill et al. / Liang et al., Jul 2024)
  // Pass = generated function passes test cases.
  // Two modes: w/ scientific background context, w/o background.
  // Numbers from Table 1 of the paper (subproblem-level pass rate).
  {
    name: 'SciCode',
    npmScript: 'bench:scicode',
    source: 'Liang et al., arXiv:2407.13168 (Jul 2024)',
    metric: 'subproblem pass rate (generated function passes test cases)',
    leaderboard: 'https://github.com/scicode-bench/scicode#leaderboard',
    overall: {
      best: {
        agent: 'w/ background context',
        model: 'o1-preview',
        passRate: 0.222,
        date: '2024-07',
        notes: 'With scientific background + sub-problem context; best at paper publication',
      },
      others: [
        { agent: 'w/ background context', model: 'o1-mini', passRate: 0.197, date: '2024-07' },
        { agent: 'w/ background context', model: 'Claude-3.5-Sonnet', passRate: 0.123, date: '2024-07' },
        { agent: 'w/ background context', model: 'GPT-4o', passRate: 0.104, date: '2024-07' },
        { agent: 'w/o background context', model: 'Claude-3.5-Sonnet', passRate: 0.047, date: '2024-07',
          notes: 'Without background context (harder)' },
        { agent: 'w/o background context', model: 'GPT-4o', passRate: 0.046, date: '2024-07' },
      ],
    },
    byDomain: {
      physics: {
        best: { agent: 'w/ background', model: 'o1-preview', passRate: 0.198, date: '2024-07' },
        others: [
          { agent: 'w/ background', model: 'Claude-3.5-Sonnet', passRate: 0.109, date: '2024-07' },
        ],
      },
      math: {
        best: { agent: 'w/ background', model: 'o1-preview', passRate: 0.261, date: '2024-07' },
        others: [
          { agent: 'w/ background', model: 'Claude-3.5-Sonnet', passRate: 0.148, date: '2024-07' },
        ],
      },
      chemistry: {
        best: { agent: 'w/ background', model: 'o1-preview', passRate: 0.214, date: '2024-07' },
        others: [
          { agent: 'w/ background', model: 'Claude-3.5-Sonnet', passRate: 0.121, date: '2024-07' },
        ],
      },
      biology: {
        best: { agent: 'w/ background', model: 'o1-preview', passRate: 0.195, date: '2024-07' },
        others: [
          { agent: 'w/ background', model: 'Claude-3.5-Sonnet', passRate: 0.113, date: '2024-07' },
        ],
      },
      materials: {
        best: { agent: 'w/ background', model: 'o1-preview', passRate: 0.233, date: '2024-07' },
        others: [
          { agent: 'w/ background', model: 'Claude-3.5-Sonnet', passRate: 0.141, date: '2024-07' },
        ],
      },
    },
  },
